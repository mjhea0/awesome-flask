...
- [Stripe Micro SaaS](https://github.com/cedendahlkim/stripe-micro-saas) - One-file Flask template with Stripe Checkout, webhooks, SQLite, and dark theme — launch a micro SaaS in 5 minutes.
